...
class Comment(models.Model):
    ...
    comment = models.ForeignKey('self',on_delete=models.CASCADE, null=True, related_name = "post_of_post")
    class Meta:
        db_table = 'comments'

class Like(models.Model):
    post = models.ForeignKey('Post', on_delete=models.CASCADE)
    user = models.ForeignKey('User', on_delete=models.CASCADE, related_name = 'like_user',null=True)
    class Meta:
        db_table = 'likes'
